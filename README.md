...
| <a name="input_tags"></a> [tags](#input\_tags) | For adding values for tags | `map(string)` | `{}` | no |
...
| <a name="input_volume_tags"></a> [volume\_tags](#input\_volume\_tags) | Specify tags for instance volumes | `map(string)` | `{}` | no |
